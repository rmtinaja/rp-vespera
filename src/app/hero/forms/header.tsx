                    ...
                    <ul className="flex items-center gap-6">
                        ...
                        <li className="relative group">
                            ...
                            <div className="absolute left-0 top-full mt-3 w-48 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <ul className="py-2 text-sm">
                                    <li><a href="/hero/products" className="block px-4 py-2 hover:bg-gray-100">Lawn Lots</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Estates</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Community Vault</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Cremation</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li className="relative group">
                            ...
                            <div className="absolute left-0 top-full mt-3 w-56 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <ul className="py-2 text-sm">
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Standard Lawn</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Standart Estates</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Community Vault</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Bone / Urn Mausoleum</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Bone / Urn Interment</a></li>
                                    <li><a href="#" className="block px-4 py-2 hover:bg-gray-100">Disinterment</a></li>
                                </ul>
                            </div>
                        </li>

                        <li><a href="" className="hover:text-[#34554f] transition">Visit Us</a></li>
                ...
                <div className="md:hidden bg-white border-t">
                    <ul className="flex flex-col p-4 space-y-3">
                        ...
                        <li>
                            ...
                            {productsOpen && (
                                <ul className="pl-4 mt-2 space-y-2 text-sm text-gray-600">
                                    <li><a href="#">Lawn Lots</a></li>
                                    <li><a href="#">Estates</a></li>
                                    <li><a href="#">Community Vault</a></li>
                        ...
                        <li>
                            ...
                            {servicesOpen && (
                                <ul className="pl-4 mt-2 space-y-2 text-sm text-gray-600">
                                    <li><a href="#">Standard Lawn</a></li>
                                    <li><a href="#">Standart Estates</a></li>
                                    <li><a href="#">Community Vault</a></li>
                                    <li><a href="#">Bone / Urn Mausoleum</a></li>
                                    <li><a href="#">Bone / Urn Interment</a></li>
                                    <li><a href="#">Disinterment</a></li>
                                </ul>
                            )}
                        </li>
